# Generated by Django 4.2.5 on 2024-02-02 17:42
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_created', models.DateTimeField(default=datetime.datetime(2024, 2, 2, 17, 42, 22, 70693, tzinfo=datetime.timezone.utc), verbose_name='Дата создания')),
                ...
                ('products', models.ManyToManyField(null=True, to='app.product', verbose_name='Товары')),
